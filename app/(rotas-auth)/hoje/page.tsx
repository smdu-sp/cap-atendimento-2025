...
export default async function ListaAgendamentoPage({
	...
	return (
		<div className=' w-full px-0 md:px-8 relative h-full  md:container mx-auto'>
			<h1 className='text-xl md:text-4xl font-bold'>
				Lista de Agendamentos ({new Date().toLocaleDateString()})
			</h1>
			<div className='flex flex-col max-w-[368px] mx-auto md:max-w-full gap-3 my-5 container w-full'>
				<Filter />
				{dados && (
					<DataTable
						columns={columns}
