...
export default function ModalDelete({
	...
	async function handleDelete(id: string) {
		...
		if (!resp.ok) {
			...
			toast.success(
				status ? 'Motivo Ativado com sucesso' : 'Motivo Deletado com sucesso',
				{
	...
	return (
		<Dialog>
			...
			<DialogContent>
				...
				{!status ? (
					<p>Tem certeza que deseja ativar esse motivo?</p>
				) : (
					<p>Tem certeza que deseja remover esse motivo?</p>
				)}
				<DialogFooter>
